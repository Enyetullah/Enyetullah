...
My project work focuses on building systems that are practical, testable, and connected to real-world use cases. I have worked on projects involving **computer vision, biometric authentication, rehabilitation technology, data logging, machine learning, and web-based applications**.
...
A Flask-based research prototype for multimodal authentication using simulated physiological input, behavioral biometrics, facial scoring, and decision-level fusion. The project explores authentication security, behavioral modeling, step-up OTP verification, evaluation logging, and risk-based login decisions.

**Key areas:** cybersecurity, authentication, behavioral biometrics, machine learning, Flask, OpenCV, SQLite
...
| **Database Skills** | I can work with SQL concepts and relational databases including MySQL, PostgreSQL, and SQLite. |
...
I am interested in opportunities where I can apply my skills in **software development, databases, data-driven applications, AI-related systems, computer vision, and cybersecurity-focused projects**.
...
I am focused on building strong technical skills, completing meaningful projects, and growing as a software developer and researcher. My GitHub reflects my work in programming, databases, computer vision, machine learning, cybersecurity, and practical software systems.
